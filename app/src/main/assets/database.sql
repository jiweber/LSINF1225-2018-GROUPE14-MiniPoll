--
-- File generated with SQLiteStudio v3.1.1 on Mon May 7 13:05:08 2018
--
...
INSERT INTO Dilemme (IDdilemme, Auteur, Titre, Participant) VALUES (1, 'harry.smith@mymail.com', 'Où vais-je manger ce soir?', 'gb@ucluvain.be');
INSERT INTO Dilemme (IDdilemme, Auteur, Titre, Participant) VALUES (2, 'gb@ucluvain.be', 'Quel pull est ce que j''achète', 'harry.smith@mymail.com');
...
INSERT INTO Question (IDquestion, IDquestionnaire, Enonce) VALUES (1, '1', 'Quand fut découvert l''Amérique ?');
INSERT INTO Question (IDquestion, IDquestionnaire, Enonce) VALUES (2, '1', 'Création de la Belgique ?');
...
INSERT INTO Relation (Utilisateur1, Utilisateur2, Statut) VALUES ('harry.smith@mymail.com', 'a', 'En attente');
...
INSERT INTO Sondage (IDsondage, Nombre_choix, Mail_auteur, Intitule) VALUES (1, 2, 'arthur98@gmail.com', 'Plus belle capitale');
INSERT INTO Sondage (IDsondage, Nombre_choix, Mail_auteur, Intitule) VALUES (2, 2, 'arthur98@gmail.com', 'Nom de mon prochain fils');

-- Table: Utilisateur
CREATE TABLE Utilisateur (Mail TEXT NOT NULL UNIQUE PRIMARY KEY, Nom TEXT NOT NULL, Prénom TEXT NOT NULL, Mot_de_passe TEXT NOT NULL, Photo TEXT NOT NULL, "Meilleur ami" TEXT, FOREIGN KEY ("Meilleur ami") REFERENCES Utilisateur (Mail));
INSERT INTO Utilisateur (Mail, Nom, Prénom, Mot_de_passe, Photo, "Meilleur ami") VALUES ('harry.smith@mymail.com', 'Smith', 'Harry', 'hsmIth123', 'default.jpeg', 'arthur98@gmail.com');
INSERT INTO Utilisateur (Mail, Nom, Prénom, Mot_de_passe, Photo, "Meilleur ami") VALUES ('arthur98@gmail.com', 'Debraie', 'Arthur', 'mot2passe', 'My_foto.jpeg', 'gb@ucluvain.be');
INSERT INTO Utilisateur (Mail, Nom, Prénom, Mot_de_passe, Photo, "Meilleur ami") VALUES ('LDV@uclouvain.be', 'De Vogeleer', 'Louis', '123', '''default.jpeg''', NULL);
INSERT INTO Utilisateur (Mail, Nom, Prénom, Mot_de_passe, Photo, "Meilleur ami") VALUES ('adb@uclouvain.be', 'de Biolley', 'Antoine', '321', '''default.jpeg''', NULL);
INSERT INTO Utilisateur (Mail, Nom, Prénom, Mot_de_passe, Photo, "Meilleur ami") VALUES ('jw@uclouvain.be', 'Weber', 'Jimmy', '596', '''default.jpeg''', NULL);
INSERT INTO Utilisateur (Mail, Nom, Prénom, Mot_de_passe, Photo, "Meilleur ami") VALUES ('gb@ucluvain.be', 'Bellon', 'Guillaume', '''0234''', '''default.jpeg''', NULL);
INSERT INTO Utilisateur (Mail, Nom, Prénom, Mot_de_passe, Photo, "Meilleur ami") VALUES ('a', 'b', 'c', 'd', 'default.jpeg', NULL);
